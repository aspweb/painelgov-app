<template><v-container>
  ...
  <!-- header -->
  <v-row>
    <h1 class="font-weight-medium blue-grey--text text--darken-4 font-size-24 mx-2">
      <v-icon class="warning--text rounded-circle float-left mt-1 mr-1">mdi-view-dashboard</v-icon>
      Visão Geral
    </h1>
  </v-row>
